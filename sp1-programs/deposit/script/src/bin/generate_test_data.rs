//! Generate deposit test data for Foundry E2E tests
//!
//! Outputs JSON to stdout that can be parsed by Foundry's FFI.
//! No SP1 needed — deposit requires no proof, just a commitment hash.
//!
//! Usage:
//!   cargo run --release --bin generate_test_data -- [token_address] [amount_wei]
